...
import { useScrollToHash, useUiSound, useWindowSize } from '~/hooks';
...
import { readMuted, writeMuted } from '~/utils/sound';
...
export const Navbar = () => {
  ...
  // The navbar is on every page, so it is where the click and hover sounds are
  // hung from. Read after mount, not during: there is no localStorage on the
  // server, and seeding from it while hydrating is a mismatch.
    ...
    <>
      <header className={styles.navbar}>
        ...
        <div className={styles.navActions}>
          ...
          {!isMobile && <SoundToggle muted={muted} onToggle={toggleSound} />}
      ...
      <Transition unmount in={menuOpen} timeout={msToNum(tokens.base.durationL)}>
        {({ visible, nodeRef }) => (
          <nav className={styles.mobileNav} data-visible={visible} ref={nodeRef}>
            ...
            <SoundToggle isMobile muted={muted} onToggle={toggleSound} />
